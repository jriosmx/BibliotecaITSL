...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            @if($titulo == 'Nueva Editorial')
                <a class="navbar-brand" href="/">&nbsp;&nbsp;< Volver </a>
            @else
                <a class="navbar-brand" href="/editoriales">&nbsp;&nbsp;< Volver </a>
            @endif
    ...
    <div class="container">
        <div class="mx-auto col-6">
            ...
            @if($titulo == 'Nueva Editorial')
                <form action="/editoriales" method="post" class="needs-validation">
            @else
                <form action="/editoriales/{{$editorial->id}}" method="post" class="needs-validation">
                @method('PUT')
            @endif    
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('editorial') is-invalid @endError" id="editorial"
                                name="editorial" value="{{old('editorial', $editorial->editorial ?? '')}}">
                            @error('editorial')
                ...
                <div class="mx-auto col-6 offset-3 mt-4">
                    ...
                    @if(Session::has('message'))
                        ...
                        @else
                            <div class="alert alert-success alert-dismissible alert-block" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="location.href='/editoriales';"><span aria-hidden="true">&times;</span></button>
                                {{Session::get('message')}}
                            </div>
                        @endif
                    @endif
